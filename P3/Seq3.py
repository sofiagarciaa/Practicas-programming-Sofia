class Seq:
    ...
    def count_base(self):
        ...
        for i in self.strbases:
            ...
            total0 = (count_a / total) * 100
            total1 = (count_c / total) * 100
            total2 = (count_g / total) * 100
            total3 = (count_t / total) * 100

        return count_a, count_c, count_g, count_t, total0, total1, total2, total3
